...
# touch(Template(tpl1536553450997.png, record_pos=(-0.031, 0.412), resolution=(720, 1280)))
# touch(Template(tpl1536553488439.png, record_pos=(-0.033, 0.412), resolution=(720, 1280)))
# touch(Template(tpl1536553504156.png, record_pos=(-0.033, 0.414), resolution=(720, 1280)))
poco("com.iris.dch.itask:id/title").child("android.widget.TextView")[1].click()
poco("com.iris.dch.itask:id/bt_recommended_level").click()
#touch(Template(tpl1536558757592.png, record_pos=(0.078, 0.233), resolution=(720, 1280)))
